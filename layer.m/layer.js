...
function(e) {
    ...
    c.prototype.view = function() {
        ...
        e.id = s.id = o[0] + r,
        s.setAttribute("class", o[0] + " " + o[0] + (n.type || 0)),
        s.setAttribute("index", r);
        var l = function() {
            var e = "object" == typeof n.title;
            var h = n.title ? '<h3 style="' + (e ? n.title[1] : "") + '">' + (e ? n.title[0] : n.title) + "</h3>": "";
                h += n.closeBtn && (n.skin == 'alert' || n.skin == 'confirm') ? "<a href='javascript:;' class='closeBtn' onclick='layer.close("+r+")'></a>" : "";
            return h
        } (),
        c = function() {
            "string" == typeof n.btn && (n.btn = [n.btn]);
            var e, t = (n.btn || []).length;
            return 0 !== t && n.btn ? (e = '<span yes type="1">' + n.btn[0] + "</span>", 2 === t && (e += '<span no type="0">' + n.btn[1] + "</span>" ), '<div class="layui-m-layerbtn">' + e + "</div>") : ""
        } ();
        if (n.fixed || (n.top = n.hasOwnProperty("top") ? n.top: 100, n.style = n.style || "", n.style += " top:" + (t.body.scrollTop + n.top) + "px"), 2 === n.type && (n.content = '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (n.content || "") + "</p>"), "msg" === n.skin && (n.shade = !1), s.innerHTML = (n.shade ? "<div " + ("string" == typeof n.shade ? 'style="' + n.shade + '"': "") + ' class="layui-m-layershade"></div>': "") + '<div class="layui-m-layermain" ' + (n.fixed ? "": 'style="position:static;"') + '><div class="layui-m-layersection"><div class="layui-m-layerchild ' + (n.skin ? "layui-m-layer-" + n.skin + " ": "") + (n.className ? n.className: "") + " " + (n.anim ? "layui-m-anim-" + n.anim: "") + '" ' + (n.style ? 'style="' + n.style + '"': "") + ">" + l + '<div class="layui-m-layercont">' + n.content + "</div>" + c + "</div></div></div>", !n.type || 2 === n.type) {
    ...
    e.layer = {
        ...
        msg:function(m,e){
            var o = { skin : 'msg' , content : m };
            for (var n in e) o[n] = e[n];
            var t = new c(o);
            return t.index
        },
        alert:function(m,e){
            var o = { btn : ['确定'] , skin : 'alert' , content : m };
            for (var n in e) o[n] = e[n];
            var t = new c(o);
            return t.index
        },
        confirm:function(m,e){
            var o = { btn : ['确定' , '取消'] , skin : 'confirm' , content : m };
            for (var n in e) o[n] = e[n];
            var t = new c(o);
            return t.index
        },
